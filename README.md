...
> **Beta:** Navichrome `0.1.0-beta.5` is the current beta of this self-hosted Navidrome/OpenSubsonic web player.
...
For a pinned beta deployment, use `ghcr.io/lozza/monochrome-navidrome:0.1.0-beta.5`.
